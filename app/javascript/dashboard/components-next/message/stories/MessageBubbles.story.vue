...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about ViperChat?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://viperchat.dev/invoice.pdf'),
      getAttachment('file', 'https://viperchat.dev/logs.txt'),
      getAttachment('file', 'https://viperchat.dev/contacts.xls'),
      getAttachment('file', 'https://viperchat.dev/customers.csv'),
      getAttachment('file', 'https://viperchat.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://viperchat.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://viperchat.dev/all-files.tar'),
      getAttachment(
        'audio',
