...
describe('useBranding', () => {
  ...
  describe('replaceInstallationName', () => {
    it('should replace "ViperChat" with installation name when both text and installation name are provided', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName('Welcome to ViperChat');

      expect(result).toBe('Welcome to MyCompany');
    });

    it('should replace multiple occurrences of "ViperChat"', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName(
        'ViperChat is great! Use ViperChat today.'
      );
    ...
    it('should return original text when installation name is not provided', () => {
      ...
      expect(result).toBe('Welcome to ViperChat');
    });
    ...
    it('should handle text without "ViperChat" gracefully', () => {
      const { replaceInstallationName } = useBranding();
    ...
    it('should be case-sensitive for "ViperChat"', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName(
        'Welcome to viperchat and VIPERCHAT'
      );

      expect(result).toBe('Welcome to viperchat and VIPERCHAT');
    });
