...
ActiveRecord::Schema[7.1].define(version: 2025_12_27_011000) do
  ...
  create_table "contatos_celular", id: false, force: :cascade do |t|
    t.integer "Id"
    t.string "First Name", limit: 150
    t.string "Last Name", limit: 150
    t.string "Display Name", limit: 150
    t.string "Nickname", limit: 150
    t.string "E-mail Address", limit: 150
    t.string "E-mail 2 Address", limit: 150
    t.string "E-mail 3 Address", limit: 150
    t.string "Home Phone", limit: 150
    t.string "Business Phone", limit: 150
    t.string "Home Fax", limit: 150
    t.string "Business Fax", limit: 150
    t.string "Pager", limit: 150
    t.string "Mobile Phone", limit: 150
    t.string "Home Street", limit: 150
    t.string "Home Address 2", limit: 150
    t.string "Home City", limit: 50
    t.string "Home State", limit: 50
    t.string "Home Postal Code", limit: 50
    t.string "Home Country", limit: 50
    t.string "Business Address", limit: 50
    t.string "Business Address 2", limit: 50
    t.string "Business City", limit: 50
    t.string "Business State", limit: 50
    t.string "Business Postal Code", limit: 50
    t.string "Business Country", limit: 50
    t.string "Country Code", limit: 50
    t.string "Related name", limit: 50
    ...
    t.string "Anniversary", limit: 50
    t.string "Gender", limit: 50
    t.string "Web Page", limit: 50
    t.string "Web Page 2", limit: 50
    t.string "Categories", limit: 50
    t.string "Middle Name", limit: 50
    t.string "Phonetic First Name", limit: 50
    t.string "Phonetic Middle Name", limit: 50
    t.string "Phonetic Last Name", limit: 50
    t.string "Name Prefix", limit: 50
    t.string "Name Suffix", limit: 50
    t.string "File As", limit: 50
    t.string "Organization Name", limit: 50
    t.string "Organization Title", limit: 50
    t.string "Organization Department", limit: 50
    t.string "photo", limit: 50
    t.string "labels", limit: 50
    t.string "E-mail 1 - Label", limit: 50
    t.string "E-mail 1 - Value", limit: 50
    t.string "Phone 1 - Label", limit: 50
    t.string "Phone 1 - Value", limit: 50
    t.string "Phone 2 - Label", limit: 50
    t.string "Phone 2 - Value", limit: 50
  end
  ...
  create_table "import-contacts", id: false, force: :cascade do |t|
    t.integer "id"
    ...
    t.string "custom_attribute_1", limit: 200
    t.string "custom_attribute_2", limit: 200
    t.string "fonenorm", limit: 200
  end
