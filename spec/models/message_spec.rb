...
RSpec.describe Message do
  ...
  describe 'message create event' do
    ...
    it 'does not update first reply but clears waiting since if the message is sent as campaign' do
    ...
    it 'does not update first reply but clears waiting since if the message is sent by automation' do
